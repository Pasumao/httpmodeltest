		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ybcpi0040",
									"targetURL": "#comaspntoolsybcpi0040-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comaspntoolsybcpi0040-display": {
								"semanticObject": "comaspntoolsybcpi0040",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.aspn.tools.ybcpi0040",
									"url": sap.ui.require.toUrl("com/aspn/tools/ybcpi0040")
								}
							}
						}
					}
